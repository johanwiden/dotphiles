...
theme.weather = lain.widget.weather({
        ...
        city_id = 2675408, -- placeholder (Sollentuna)
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 60, bg = theme.bg_normal, fg = theme.fg_normal })
    ...
    s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, border_width = 0, height = 60, bg = theme.bg_normal, fg = theme.fg_normal })
