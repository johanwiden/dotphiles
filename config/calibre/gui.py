...
# Main window geometry
main_window_geometry = cPickle.loads('\x80\x02csip\n_unpickle_type\nq\x01U\x0cPyQt5.QtCoreq\x02U\nQByteArrayUB\x01\xd9\xd0\xcb\x00\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\x1e\x00\x00\x0e\xff\x00\x00\x06*\x00\x00\x00\x00\x00\x00\x00\x1e\x00\x00\x0e\xff\x00\x00\x06*\x00\x00\x00\x00\x00\x00\x00\x00\x0f\x00\x00\x00\x00\x00\x00\x00\x00\x1e\x00\x00\x0e\xff\x00\x00\x06*\x85\x87Rq\x03.')
...
main_search_history = cPickle.loads('\x80\x02]q\x01(X\x18\x00\x00\x00authors:"=Jeff Geerling"q\x02X\x07\x00\x00\x00calibreq\x03e.')
 
# viewer search history
# Search history for the e-book viewer
viewer_search_history = cPickle.loads('\x80\x02]q\x01(X\x04\x00\x00\x00junoq\x02X\x07\x00\x00\x00projectq\x03e.')
