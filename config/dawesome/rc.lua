...
-- run_once({ "xmodmap -display :1 /home/jw/.Xmodmap,unclutter -root,xscreensaver -display :1 -no-splash" }) -- entries must be comma-separated
...
local modkey       = "Mod4"
local altkey       = "Mod1"
-- local terminal     = "xterm -fa 'dejavu sans mono' -fs 11"
...
local theme_path = string.format("%s/.config/dawesome/themes/%s/theme.lua", os.getenv("HOME"), chosen_theme)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86MonBrightnessDown", function ()
         awful.util.spawn("sudo /usr/local/bin/sysbacklight down") end),
    awful.key({ }, "XF86MonBrightnessUp", function ()
          awful.util.spawn("sudo /usr/local/bin/sysbacklight up") end),
    -- Hotkeys
    ...
    awful.key({ modkey,           }, "F12",
        ...
        {description = "lock screen", group = "tag"}),
    ...
    awful.key({ modkey,           }, "a", function () awful.menu.clients({ theme = { width = 250 } }) end,
              {description = "show clients menu", group = "awesome"}),
    ...
    awful.key({ modkey, altkey, "Control" }, "+", function () lain.util.useless_gaps_resize(1) end),
    awful.key({ modkey, altkey, "Control" }, "-", function () lain.util.useless_gaps_resize(-1) end),
    ...
    awful.key({ modkey, altkey, "Shift"   }, "l",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "layout"}),
    awful.key({ modkey, altkey, "Shift"   }, "h",     function () awful.tag.incmwfact(-0.05)          end,
    ...
    awful.key({ modkey, altkey }, "Up",
        ...
        {description = "volume up", group = "mixer"}),
    awful.key({ modkey, altkey }, "Down",
        function ()
            os.execute(string.format("amixer -q set %s 1%%-", beautiful.volume.channel))
            beautiful.volume.update()
        end,
        {description = "volume down", group = "mixer"}),
    ...
    awful.key({ modkey, altkey, "Control" }, "m",
        ...
        {description = "max volume", group = "mixer"}),
    awful.key({ modkey, altkey, "Control" }, "0",
        function ()
            os.execute(string.format("amixer -q set %s 0%%", beautiful.volume.channel))
            beautiful.volume.update()
        end,
        {description = "min volume", group = "mixer"}),
    ...
    awful.key({ modkey, altkey, "Control" }, "Left",
        function ()
            awful.spawn.with_shell("mpc prev")
            beautiful.mpd.update()
        end,
        {description = "mpc prev", group = "mpd"}),
    awful.key({ modkey, altkey, "Control" }, "Right",
        function ()
    ...
    awful.key({ modkey, altkey }, "0",
        ...
        {description = "MPD widget", group = "mpd"}),

    -- Copy primary to clipboard (terminals to gtk)
    awful.key({ modkey }, "c", function () awful.spawn("xsel | xsel -i -b") end,
        {description = "copy to clipboard", group = "copy"}),
    -- Copy clipboard to primary (gtk to terminals)
    awful.key({ modkey }, "v", function () awful.spawn("xsel -b | xsel") end,
        {description = "paste", group = "copy"}),

    -- User programs
    awful.key({ modkey }, "e", function () awful.spawn(gui_editor) end,
        {description = "gui_editor", group = "launcher"}),
...
clientkeys = awful.util.table.join(
    awful.key({ modkey, altkey, "Shift"   }, "m",      lain.util.magnify_client                         ),
    awful.key({ modkey,           }, "f",
        function (c)
